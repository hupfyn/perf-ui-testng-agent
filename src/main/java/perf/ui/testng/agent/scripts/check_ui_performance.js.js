(function () {
    ...
    function getTransferSize(url) {
        var result = resources.filter(function (resource) { return resource.name === url });
    ...
    function getAbsoluteURL(url) {
        return window.document.createElement('a').href = url
    }
    ...
    function checkAccessibility() {
        ...
        function accessLabelOnInput() {
            function getMatchingLabel(id, labels) { return labels.filter(function (entry) { return entry.attributes.for && entry.attributes.for.value === id }) }
        ...
        function accessNeverSuppressZoom() {
            function caseInsensitiveAttributeValueFilter() {
                return function (item) {
                    ...
                    if (attribute.toLowerCase() === 'viewport') { return item }
                    return undefined
                }
            }
            var metasData = []
    ...
    function checkBestPractice() {
        ...
        function bestPracticeDoctype() {
            ...
            return [score, docType]
        }

        function bestPracticeHttpsH2() {
            var score = 100
            var protocol = getProtocol(docUrl)
        ...
        function bestPracticeMetaDescription() {
            var score = 100
            var metas_local = metas.filter(function (metas) { return metas.name == 'description' });
    ...
    function checkPrivacy() {
        ...
        return {
            ...
            https: [docUrl.indexOf('https://') === -1 ? 0 : 100, getProtocol(docUrl)],
